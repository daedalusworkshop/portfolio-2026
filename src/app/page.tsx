    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-8 pt-28 pb-16">
      <div className="w-full max-w-2xl flex flex-col gap-[1.25em]">
        ...
        <p className={cls} style={style}>
          ...
          . It&rsquo;s in{' '}
          <Link href="/design/project-telephone" className="underline underline-offset-4 decoration-1 hover:text-white/60 transition-colors">the telephone booth that brings out our blues</Link>
          . It&rsquo;s in{' '}
